...
type PostRepository interface {
	...
	Create(userId UserKey, text PostText) (*Post, error)
	Get(postId PostKey) (*Post, error)
	GetPostOwner(postId PostKey) (UserKey, error)
	UpdatePost(postId PostKey, newText PostText) (*Post, error)
...
type SocialNetworkService interface {
	...
	CreatePost(userId UserKey, text PostText) (PostKey, error)
	GetPost(userId UserKey, postId PostKey) (*Post, error)
	UpdatePost(userId UserKey, postId PostKey, newText PostText) error

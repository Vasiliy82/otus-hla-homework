...
![golang clean architecture](https://github.com/Vasiliy82/otus-hla-homework/raw/master/clean-arch.png)
...
- All libraries listed in [`go.mod`](https://github.com/Vasiliy82/otus-hla-homework/blob/master/go.mod)
